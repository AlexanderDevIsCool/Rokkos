...
ActiveRecord::Schema.define(version: 2018_11_27_180213) do
  ...
  create_table "product_tags_joins", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["product_id"], name: "index_product_tags_joins_on_product_id"
    t.index ["tag_id"], name: "index_product_tags_joins_on_tag_id"
  end
